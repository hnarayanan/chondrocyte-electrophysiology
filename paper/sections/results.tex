...
\begin{figure}
  \centering
  \includegraphics[width=0.8\textwidth]{../results/pdf/concentrations}
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\textwidth]{../results/pdf/background_currents}
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\textwidth]{../results/pdf/pumps_and_exchangers}
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\textwidth]{../results/pdf/potassium_currents}
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\textwidth]{../results/pdf/other_currents}
