...
\begin{figure}
  \centering
  \subfloat{\includegraphics[width=0.36\textwidth]
...
\todo{Debug the hypothesis plots and talk about the implications}

\begin{figure}
  \centering
  \subfloat[Without BUP]{\includegraphics[width=0.36\textwidth]
    {../results/pdf/20110902/t-V-withoutBUP.pdf}}
  \subfloat[With BUP]{\includegraphics[width=0.36\textwidth]
    {../results/pdf/20110902/t-V-withBUP.pdf}}\\
  \subfloat{\includegraphics[width=0.36\textwidth]
    {../results/pdf/20110902/t-K_o}}
  \subfloat{\hspace{0.36\textwidth}}
  \caption{Evolution of membrane potential with varying external
