...
regions of cartilage. This cartilage environment can be modelled
simply by (fixed) external concentrations \Nao, \Ko, \Cao, \Ho and
\Clo. Values for these concentrations are chosen within
...
\todo{{\bf Question:} We currently model Kv1.5. Do we need to replace
this with Kv1.4 from, e.g., Nygren et al.?}
