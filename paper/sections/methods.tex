...
\todo{{\bf Harish:} Needs some introductory text here. Point to the
  fact that the discussion contains other identified channels not
...
%\todo{{\bf Molly:} Notes below need to used to motivate the choice of
%  external concentrations of species along with Clark et al.'s
...
%Extracellular pH affects the chondrocyte metabolism and rate of matrix synthesis \citep{BarrettJolleyetal2010}; however, the rate of collagen synthesis seems to be independent of pH \citep{Wuetal2007}.
As the tissue is avascular, 
%chondrocytes must scavenge precursor molecules for matrix macromolecular synthesis \citep{Holmetal1998, Stockwell1991}.  
...
measured values from \cite{Clarketal2011} to characterize the extracellular environment of the chondrocyte in our model.
