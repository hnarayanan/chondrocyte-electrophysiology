...
\todo{{\bf Harish:} Need some introductory text here}
...
of their interior and exterior concentrations:
\begin{equation}
  \begin{split}
...
articular chondrocytes: CFTR (citation). Such channels are likely
