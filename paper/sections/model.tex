...
\todo{Make sure the following figure is updated to match the final
...
\subsection*{The different channels incorporated into the model}
\label{sec:chondrocyte-channels}

\todo{Clean up the following mishmash of notes and equations}
