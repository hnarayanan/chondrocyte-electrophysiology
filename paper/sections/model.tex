...
\todo{Update the following figure with the final selection of
  channels}
...
\todo{Discuss details of how it is done here. Methods used, and the
  paramterisation and the fact that the code is available for free for
  others to test and extend.}
