...
global Na_o   = 300;       # Clamped external sodium concentration (mM/l)
global K_o_0  = 7;        # Clamped external potassium concentration (mM/l)
global Ca_o   = 10;        # Clamped external calcium concentration (mM/l)
global H_o    = 10^(-6.8); # Clamped external hydrogen concentration (mM/l)
...
# global V_0 = -140;
global V_0     =   -4.06087687776104e+01  # Initial membrane potential (mV)
global Na_i_0  =     5.13512644944244e+00 # Initial internal sodium concentration (mM/l)
global K_i_0   =     1.25789900531661e+02 # Initial internal potassium concentration (mM/l)
global Ca_i_0  =     1.09753586355661e-05 # Initial internal calcium concentration (mM/l)
global H_i_0   =     2.70389987460558e-09 # Initial internal hydrogen concentration (mM/l)
global Cl_i_0  =     1.94768655355571e+01 # Initial internal chloride concentration (mM/l)
