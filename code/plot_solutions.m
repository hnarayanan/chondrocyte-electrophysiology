...
subplot(2, 2, 1), plot(K_o, V, 'linewidth', line_width), xlabel('$[K^{+}]_{\mathrm{o}} (mM/l)$'), legend('$V_{\mathrm{m}} (mV)$');
subplot(2, 2, 2), plot(t, K_o, 'linewidth', line_width), xlabel('$t (s)$'), legend('$[K^{+}]_{\mathrm{o}} (mM/l)$');
