...
print -depslatexstandalone "../results/epslatex/t_V.tex"

# Plot total ionic current vs time
plot(t, I_i, 'linewidth', line_width), xlabel('$t (s)$'), ylabel('$I_i (pA)$');
print -depslatexstandalone "../results/epslatex/t_I_i.tex"
